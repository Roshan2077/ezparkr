            ...
            >
              <div className="flex items-center justify-between mb-8">
                ...
                <button
                  ...
                  className="p-3 bg-white/80 backdrop-blur-md rounded-full border border-[#87BED7]/30 text-[#87BED7] hover:bg-[#87BED7]/20 transition-all duration-200 shadow-lg hover:shadow-xl"
                  title="Preferences"
                >
                  <Settings size={20} />
                </button>
